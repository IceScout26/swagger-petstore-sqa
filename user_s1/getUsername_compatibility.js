...
export default function () {
    ...
    let usernames = [
        ...
        // "invalid_user_123", // ❌ Invalid username
    ...
    console.log(`Iteration: ${__ITER} | Status: ${res.status} | Username: ${username} | Headers: ${JSON.stringify(headers)}`);
    ...
    check(res, {
        ...
        // 'unexpected error': (r) => r.status !== 500,
