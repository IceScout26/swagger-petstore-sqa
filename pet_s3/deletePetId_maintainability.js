...
export let options = {
    stages: [
        { duration: '2m', target: 75 },  // Load normal
        { duration: '6m', target: 750 }, // Lonjakan (simulasi kegagalan)
        { duration: '2m', target: 75 },  // Pemulihan (cek kapan kembali ke normal)
    ],
};
...
export default function () {
    ...
    // Anggap 200 dan 404 bukan failure
