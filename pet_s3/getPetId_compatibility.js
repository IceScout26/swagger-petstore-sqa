...
export default function () {
    ...
    let petIds = [
        1, // ✅ Valid petId
        "invalid", // ❌ Invalid petId 
        // "longpetid".repeat(1000) // ❌ Extremely long petId (string)
    ];
    ...
    let petId = petIds[__ITER % petIds.length]; // Variasi petId berdasarkan iterasi
    ...
    console.log(`Iteration: ${__ITER} | Status: ${res.status} | PetId: ${petId} | Headers: ${JSON.stringify(headers)}`);
